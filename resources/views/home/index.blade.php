...
$bg = 'blue';
        @endphp
        <x-card :$color :bgColor="$bg">
            <x-slot:title class="card-header-blue"> Card title 1 </x-slot>
            Card content
            <x-slot:footer> Card footer 1 </x-slot>
        </x-card>

        <x-test-component class="red">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Voluptatibus ipsam quia nulla nemo sint aliquam voluptatum deserunt quis maxime sapiente quos illo amet, veniam laborum officia dignissimos magnam dolores adipisci.
        </x-test-component>
        <!-- Find a car form -->
